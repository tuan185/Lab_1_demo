...
int main(void)
{
  ...
  uint8_t red_counter = 6;
  uint8_t green_counter = 3;
  uint8_t yellow_counter = 2;
  uint8_t status = 0;		// 0-red, 1-green, 2-yellow
  /* USER CODE END Init */
